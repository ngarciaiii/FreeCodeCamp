...
console.log("GOOG_KEY: " + process.env.GOOG_KEY);
console.log("OWM_KEY: " + process.env.OWM_KEY);
//
...
$(document).ready(function() {
	...
	$.getJSON("https://www.googleapis.com/geolocation/v1/geolocate?key=GOOG_KEY", function(data){
		lat = data.lat;
		lon = data.lon;
